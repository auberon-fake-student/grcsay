# grcsay
An exercise for collaborating with git / GitHub. I guess you can read the directions CAREFULLY! I recommend focusing on the changes to the README before reading the Java code.
